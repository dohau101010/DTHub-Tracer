      ...
      if (message === "dth_init") {
        ...
        supportDiv.innerHTML = `
            ...
            <label for="file-upload" class="upload-label">
              <img src="https://cdn-icons-png.flaticon.com/512/724/724933.png" alt="Upload Icon" class="upload-icon">
              <p>Drag and drop or <span>Click here</span> to upload file(s)</p>
...
function setupFileUpload() {
  ...
  function handleFiles(files) {
    if (files.length > 0) {
      ...
      // Xóa thẻ <small> nếu tồn tại
      const smallTag = uploadStatus.parentElement.querySelector("small");
      if (smallTag) {
        smallTag.remove();
      }
    }
