              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr onclick= "updateSubVideo3xxx()">
                    <td>
                      <img src="./img/boy.png" />
                      <p>Thay Trang (Data Communication System)</p>
                    </td>
                    <td>15</td>
                    <td><div class="status process">New</div></td>
                    <td><div class="status process">New</div></td>
                  ...
                  <tr onclick= "updateSubVideo4xxx()">
                    <td>
                      <img src="./img/boy.png" />
                      <p>Thay Tan (Integrated Circuit & System Design)</p>
                    </td>
                    <td>10</td>
                    <td><div class="status checking">In Trace</div></td>
                    <td><div class="status process">New</div></td>
                  ...
                  <tr onclick= "updateSubVideo7xxx()">
                    <td>
                      <img src="./img/boy.png" />
                      <p>Thay Phuc (C Programming Language)</p>
                    </td>
                    <td>10</td>
                    <td><div class="status checking">In Check</div></td>
                    <td><div class="status process">New</div></td>
